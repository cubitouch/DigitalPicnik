...
namespace DigitalPicnik
{
    ...
    public partial class List : System.ICloneable, System.IComparable, System.IComparable<DigitalPicnik.List>, CodeFluent.Runtime.ICodeFluentCollectionEntity<System.Guid>, System.ComponentModel.IDataErrorInfo, CodeFluent.Runtime.ICodeFluentMemberValidator, CodeFluent.Runtime.ICodeFluentSummaryValidator, System.IEquatable<DigitalPicnik.List>
    {
        ...
        private DigitalPicnik.ItemCollection _items;
        ...
        [System.Xml.Serialization.XmlIgnoreAttribute()]
        public DigitalPicnik.ItemCollection Items
        {
            get
            {
                if ((this._items == null))
                {
                    ...
                    {
                        this._items = new DigitalPicnik.ItemCollection(this);
                        return this._items;
                    }
                    this._items = DigitalPicnik.ItemCollection.LoadByList(this);
                }
                return this._items;
            }
        }
        ...
        public virtual bool Equals(DigitalPicnik.List list)
        {
            if ((list == null))
            {
                return false;
            ...
            return (this.Id.Equals(list.Id) == true);
        }
        ...
        public override bool Equals(object obj)
        {
			...
			list = obj as DigitalPicnik.List;
...
list = value as DigitalPicnik.List;
            ...
            int localCompareTo = this.CompareTo(list);
            return localCompareTo;
        }
        
        public virtual int CompareTo(DigitalPicnik.List list)
        {
            if ((list == null))
            {
                throw new System.ArgumentNullException("list");
            }
            int localCompareTo = this.Id.CompareTo(list.Id);
            return localCompareTo;
        }
        ...
        public virtual void Validate(System.Globalization.CultureInfo culture, System.Collections.Generic.IList<CodeFluent.Runtime.CodeFluentValidationException> results)
        {
            ...
            if ((evt.Cancel == true))
            {
                ...
                {
                    externalValidate = DigitalPicnik.Resources.Manager.GetStringWithDefault(culture, "DigitalPicnik.List.ExternalValidate", "Type \'DigitalPicnik.List\' cannot be validated.", null);
                }
            ...
            if ((this.Id.Equals(CodeFluentPersistence.DefaultGuidValue) == true))
            {
                string localValidate = DigitalPicnik.Resources.Manager.GetStringWithDefault(culture, "DigitalPicnik.List.Id.NullException", "\'Id\' property cannot be set to \'00000000-0000-0000-0000-000000000000\' for type \'D" +
                        "igitalPicnik.List\'", null);
        ...
        public virtual bool Delete()
        {
            ...
            persistence.CreateStoredProcedureCommand(null, "List", "Delete");
        ...
        protected virtual void ReadRecord(System.Data.IDataReader reader, CodeFluent.Runtime.CodeFluentReloadOptions options)
        {
            ...
            if ((((options & CodeFluent.Runtime.CodeFluentReloadOptions.Properties) 
                        ...
                        == false))
            {
                this._id = CodeFluentPersistence.GetReaderValue(reader, "List_Id", ((System.Guid)(CodeFluentPersistence.DefaultGuidValue)));
                this._title = CodeFluentPersistence.GetReaderValue(reader, "List_Title", ((string)(default(string))));
                this._description = CodeFluentPersistence.GetReaderValue(reader, "List_Description", ((string)(default(string))));
            }
        ...
        public static DigitalPicnik.List Load(System.Guid id)
        {
            ...
            CodeFluent.Runtime.CodeFluentPersistence persistence = CodeFluentContext.Get(DigitalPicnik.Constants.DigitalPicnikStoreName).Persistence;
            persistence.CreateStoredProcedureCommand(null, "List", "Load");
        ...
        protected virtual void BaseTrace(System.CodeDom.Compiler.IndentedTextWriter writer)
        {
            ...
            if ((this._items != null))
            {
                ((CodeFluent.Runtime.ICodeFluentObject)(this._items)).Trace(writer);
            }
            else
            {
                writer.Write("<null>");
        ...
        public DigitalPicnik.List Clone(bool deep)
        {
            DigitalPicnik.List list = new DigitalPicnik.List();
            this.CopyTo(list, deep);
            return list;
        }
        
        public DigitalPicnik.List Clone()
        {
            DigitalPicnik.List localClone = this.Clone(true);
            return localClone;
        }
        ...
        public virtual void CopyTo(DigitalPicnik.List list, bool deep)
        {
            if ((list == null))
            {
                throw new System.ArgumentNullException("list");
            ...
            this.OnEntityAction(new CodeFluent.Runtime.CodeFluentEntityActionEventArgs(this, CodeFluent.Runtime.CodeFluentEntityAction.CopyTo, false, list));
        }
